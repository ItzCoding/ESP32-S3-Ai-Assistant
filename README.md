...
> **Current firmware:** ESP32-AI v1.8.0  
...
#define METEOSOURCE_API_KEY     "YOUR_METEOSOURCE_API_KEY"
#define SERPER_API_KEY          "YOUR_SERPER_API_KEY"

#define SKILL_OPENROUTER_KEY    "YOUR_OPENROUTER_SKILL_API_KEY"
```
...
4. Open `ESP32-S3-AI-Assistant-v1.7.9.ino`.
...
The assistant can check GitHub Releases and install newer firmware without reconnecting the board over USB.
...
- The release must contain the generated `.ino.bin` application file.
...
```text
ESP32-S3-AI-Assistant-v1.7.9.ino
│
├── 01_config.h
├── 02_types.h
├── 03_globals.h
...
- Confirm the release contains the `.ino.bin` firmware asset.
...
| File | Purpose |
|---|---|
| `ESP32-S3-AI-Assistant-v1.7.9.ino` | Main Arduino sketch |
...
The main sketch filename remains unchanged for Arduino project compatibility, while the firmware reports version `1.8.0`.
...
Made by: Sethun Vithanamwasam (ItzFlameG)
