...
// ║  v1.7.9  : FIXED AI response display (streaming output bug)             ║
// ║  v1.7.9  : Multi-language auto-detect (Arabic/Chinese/Russian…)         ║
// ║  v1.7.9  : Full FreeRTOS overhaul — SW timers, LED task,                ║
// ║            background OTA task, Serial input queue, mutex               ║
...
namespace Config {
  ...
  // Web search / Weather
  constexpr const char* WEATHER_KEY    = "YOUR_METEOSOURCE_KEY";   // meteosource.com
